...
namespace Capstone
{
    public class CLI
    {
        ...
        {
            Console.WriteLine("Please take your change: $" + _vm.Balance);
            _vm.CashOut();
            Console.ReadKey();
        }
        ...
        {
            Console.Clear();
            Console.WriteLine("Slot".PadRight(8) + " | " + "Name".PadRight(18) + " | " + "Price".PadRight(7) + " | " + "Quantity");
            foreach (KeyValuePair<string, Product> kvp in _vm.Inventory)
            {
                Console.WriteLine(kvp.Key.PadRight(8) + " | " + kvp.Value.Name.PadRight(18) + " | " + kvp.Value.Price.ToString("C").PadRight(7) + " | " + kvp.Value.Quantity);
            }
        }
    }
}
